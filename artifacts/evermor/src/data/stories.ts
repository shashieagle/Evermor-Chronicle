...
export const stories: Story[] = [
  ...
  },
  {
    ...
    hasFilm: false,
    narrative:
      "Mysore in the late afternoon holds a particular quality of light — amber and unhurried, the kind that makes everything it touches look like it has always been there. Meghana and Vijay chose this light for their beginning, and the light, in return, was generous with them.",
