...
const paragraphs: (string | null)[] = [
  ...
  null,
  "We've been photographing weddings for years. We've stood beside hundreds of families, witnessed nervous brides, teary parents, chaotic friends, and the quiet moments that happen between two people on a wedding day.",
  null,
  ...
  "Something changed.",
  null,
  "We realised the photographs we treasured most weren't necessarily the beautiful ones. They were the ones that brought something back — a glance, a conversation, a parent's expression, a moment we had almost forgotten.",
  null,
  "That changed the way we photograph.",
  null,
  "Today, we don't arrive simply to document a celebration. We arrive curious about the people behind it — what matters to them, who they love, and which moments might still mean something years from now.",
  null,
  "Because a wedding lasts a day.",
  null,
  "The beginning of a family lasts much longer.",
];
