    ...
    <div className="bg-[#EFEFED] text-[#F5F0E8]">
      ...
      <section className="relative h-[100vh] w-full overflow-hidden bg-[#1A1612]">
        ...
        <div className="absolute bottom-[18%] md:bottom-[22%] left-6 md:left-16 right-6 md:right-auto max-w-[680px] z-10">
          ...
          >
            <span className="text-[13px]">Discover the gift from evermor</span>
            <span>→</span>
          </Link>
        </div>
      </section>
            ...
            >
              <div className="p-[10px] md:p-[12px] pb-0">
                ...
                <div className="px-3 pt-4 pb-5">
                  <p className="font-serif italic text-[#3A342C]/60 text-[19px] text-center font-medium">
                  ...
                  <p className="font-sans text-[#3A342C]/30 tracking-[0.12em] uppercase mt-2.5 text-[13px] text-center font-bold">— Shaun &amp; Sowmya</p>
                </div>
              </div>
            </Link>
